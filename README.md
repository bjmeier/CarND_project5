...
The most difficult issue was dealing with shadows.  To counteract this, a low pass filter was required. The eliminated any panic stops, but delayed detection.  To counter this, I could use a more robust deep learning  based detection method.  Also, I could implement a method of tracking cars to avoid the merging of two cars is desirable. 
