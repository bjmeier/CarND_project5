...
The most difficult issue was dealing with shadows.  To counteract this, a low pass filter was required. The elimated any panic stops, but delayed detection.  To counter this, I suggest using a more robust deep learning  based detection method.  Also, I would implement a method of tracking cars to avoid the merging of two cars is desireable. 
